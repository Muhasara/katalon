...
if (WebUI.verifyElementNotPresent(findTestObject('Object Repository/HomePage/Roles'), 5, FailureHandling.OPTIONAL)) {
	WebUI.click(findTestObject('Object Repository/HomePage/Users_Settings'))
}

WebUI.delay(1)

WebUI.click(findTestObject('Object Repository/HomePage/Roles'))

WebUI.click(findTestObject('Filter/div_f_mainUserGroup'))
...
WebUI.click(findTestObject('Object Repository/Filter/div_f_permissions'))
